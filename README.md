...
Hit up `http://127.0.0.1:1337/`. Give it a while because it's gotta do > 200 HTTP requests. I removed the console.log calls, but I should have left them in really. Oops.
